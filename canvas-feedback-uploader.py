...
def upload_feedback(course_id, assignment_id, user_id, file_path):
    ...
    if completion_response.status_code == 200:
        ...
        submission_url = f'https://canvas.instructure.com/api/v1/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}'

        # Verify JSON Payload for Submission Update
        payload = {
